...
{
    public sealed class MudDateTimePickerFormComponentInstance : DateTimeInputFormComponentInstance
    {
        public MudDateTimePickerFormComponentInstance() : base(typeof(MudBlazorDateTimePicker<>))
        {
        }
