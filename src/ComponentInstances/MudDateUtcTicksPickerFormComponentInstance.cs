...
{
    public sealed class MudDateUtcTicksPickerFormComponentInstance : DateOnlyUtcTicksInputFormComponentInstance
    {
        public MudDateUtcTicksPickerFormComponentInstance() : base(typeof(MudBlazorDatePicker<>))
        {
        }
